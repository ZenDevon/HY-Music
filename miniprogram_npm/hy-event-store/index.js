...
__DEFINE__(1712203518058, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1712203518059,"./event-store":1712203518060}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1712203518059, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1712203518060, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1712203518059,"./utils":1712203518061}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1712203518061, function(require, module, exports) {
...
return __REQUIRE__(1712203518058);
})()
